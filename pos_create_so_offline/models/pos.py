...
class sale_order(models.Model):
    ...
    pos_reference = fields.Char(string='Recibo', readonly=True, copy=False)
...
class pos_config(models.Model):
    ...
    allow_create_sale_order = fields.Boolean("POS de Ruta")
    pos_sale_order_state = fields.Selection([('draft', 'Cotizacion'), ('sale_order', 'Confirmado')],'Estado de la orden', default='draft')