...
class PosConfig(models.Model):
    ...
    enable_order_sync = fields.Boolean("Sincronizar Operacion de Mayoreo")
    enable_operation_restrict = fields.Boolean("Restringir funciones POS")
    pos_managers_ids = fields.Many2many('res.users', 'pos_config_partner_rel', 'location_id', 'partner_id',string='Gerentes')
