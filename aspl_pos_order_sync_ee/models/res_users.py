...
class ResUsers(models.Model):
    ...
    pos_user_type = fields.Selection([('cashier', 'Cajero Mayoreo'), ('salesman', 'Vendedor mostrador de mayoreo')], string="Tipo de usuario Mayoreo",default='salesman')
    ...
    based_on = fields.Selection([('pin', 'Pin'), ('barcode', 'Barcode')],default='barcode', string="Autentificar al gerente con: ")
